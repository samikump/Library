...
public class RegistrationController {
    ...
    public String processRegistration(
            @Valid @ModelAttribute("newuser") NewUser user, BindingResult bindingResult, RedirectAttributes redirectAttributes) {

        //Test if input is correct
        if (bindingResult.hasErrors()) {

            redirectAttributes.addFlashAttribute(
                    "registrationError","Username or password is too short");
